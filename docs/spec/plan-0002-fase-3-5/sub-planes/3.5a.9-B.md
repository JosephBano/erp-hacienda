# 3.5a.9-B — Árbol de actividades y navegación de campo
...
- **ADR que la respalda:** ninguno directo (vive en el macro plan sec.2.3 y se apoya en
  ...
  [3.5a.9-A](./3.5a.9-A.md)).
- **Par de split:** [`3.5a.9-A`](./3.5a.9-A.md) (visibilidad de módulos por interruptor explícito)
...
2. **Filtrado por capacidades.** Cada nodo expone `requiresCapabilities: Capability[]`
   ...
   interruptor de módulo de [3.5a.9-A](./3.5a.9-A.md)
