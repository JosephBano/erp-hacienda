# 3.5a.2-B — Lógica de dosis y series de tratamiento
...
- **Pares del split:**
  - [`3.5a.2-A`](./3.5a.2-A.md) (rama `feature/livestock-treatment-catalog`): los catálogos `administration_routes`, `TreatmentReason`, el payload, `health_plan_item_id` nullable, y `applied_by` ≠ `recorded_by`. **Esta sub-rama requiere A mergeado.**
  - [`3.5a.2-C`](./3.5a.2-C.md) (rama `feature/field-app-treatment-ui`): la pantalla de campo que consume lo definido aquí.
...
[`PROTOCOLO-DE-TRABAJO.md`](../../../PROTOCOLO-DE-TRABAJO.md), y (b) mezclaba tres órdenes de magnitud de cambio:
