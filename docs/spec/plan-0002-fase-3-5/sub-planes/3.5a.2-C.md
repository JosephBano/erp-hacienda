# 3.5a.2-C — Vacunación como camino separado y UI de campo
...
- **ADRs que la respaldan:** ninguno nuevo (la separación tratamiento/vacunación
  es una decisión de UX respaldada por [`PROTOCOLO-DE-TRABAJO.md`](../../../PROTOCOLO-DE-TRABAJO.md) y el principio de los
  tres toques).
- **Pares del split:**
  - [`3.5a.2-A`](./3.5a.2-A.md) (rama `feature/livestock-treatment-catalog`): catálogos y payload — **requerido**.
  - [`3.5a.2-B`](./3.5a.2-B.md) (rama `feature/livestock-treatment-dose-logic`): lógica de dosis y `TreatmentCourse` — **requerido**.
...
> PR** (regla "un PR = un propósito" de [`PROTOCOLO-DE-TRABAJO.md`](../../../PROTOCOLO-DE-TRABAJO.md) — el
...
5. **Pantalla `VaccinateScreen` en `field-app`.** Camino principal del
   ...
   - Lote o sujeto (animal / lote) en el primer toque, vía búsqueda o recientes
     (lo provee [3.5a.9-B](./3.5a.9-B.md), que ya debió
...
8. **Camino "Lo que registré hoy":** las dos pantallas empujan sus
   ...
   [3.5a.8](../spec-3.5a.md#35a8--featurefield-app-corrections-adr-0017)
...
9. **`TreatmentCourse` se refleja en la UI como una sola fila de la lista
   ...
   [3.5a.2-B](./3.5a.2-B.md#tareas)); la pantalla hoy no
...
10. **Caminos de salida y "cancelar" explícitos** — si la pantalla se cierra a
    ...
    [`3.5a.0`](../spec-3.5a.md#35a0--featurefield-app-input-guards--empezar-por-acá)
...
4. **Tres toques para vacunación individual.** Sembrar 1 animal con su arete.
   ...
   [3.5a.9-B](./3.5a.9-B.md), pero específica de esta
   pantalla.
...
- La **ficha del lote** con el último tratamiento aplicado — eso es
  [`3.5a.7`](../spec-3.5a.md#35a7--featurefield-app-lot-registration).
