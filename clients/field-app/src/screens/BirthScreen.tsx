...
export function BirthScreen({
  ...
  /**
   * docs/planes/fase-3-5/spec.md 3.5a.0 #2: the litter is editable, not append-only. The client
  ...
  /**
   * docs/planes/fase-3-5/spec.md 3.5a.4 task 3: birth weight is the first-day metric the client
