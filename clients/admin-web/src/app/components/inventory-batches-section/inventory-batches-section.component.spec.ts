...
describe('InventoryBatchesSectionComponent', () => {
  ...
  it('renders the expiration date column', () => { const fixture = TestBed.createComponent(InventoryBatchesSectionComponent); fixture.componentInstance.batches = batches; fixture.detectChanges(); const expected = new Date(batches[0].expirationDate!).toLocaleDateString('es-EC'); expect(fixture.nativeElement.textContent).toContain(expected); });
