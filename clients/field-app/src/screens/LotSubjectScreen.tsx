...
interface LotSubjectScreenProps {
  ...
  /**
   * The lot record read (PLAN-FASE-3-5-PORCINO.md sec.3.5a.7 task 6, already
 ...
 * (PLAN-FASE-3-5-PORCINO.md sec.2.3, "el más frecuente"), so it leads; pesaje muestral is
