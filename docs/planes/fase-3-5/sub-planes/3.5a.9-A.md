# 3.5a.9-A — Visibilidad de módulos por interruptor explícito

> **Sub-plan de la Fase 3.5, sec.3.5a.9** — extraído del antiguo plan único de la
> fase, hoy [`spec-3.5a.md`](../spec-3.5a.md) sec.3.5a.9. Donde este documento dice "macro plan"
...
- **Par de split:** [`3.5a.9-B`](./3.5a.9-B.md) (navegación por árbol de actividades)
- **Fuente original:** [`spec-3.5a.md` sec.3.5a.9](../spec-3.5a.md#35a9--featurefield-app-herd-navigation--split-en-35a9-a-y-35a9-b)
...
- Sección sec.2.3 del macro plan: el árbol de actividades de campo se filtra por
  **interruptor de módulo ∧ capacidades de la finca ∧ permisos del usuario**. Esta
  ...
  evalúa [3.5a.9-B](./3.5a.9-B.md); "permisos" ya existe vía
  ADR-0007.
...
- El árbol de actividades completo, con sujeto como primer nivel y filtrado por
  especie-capacidades. Eso es [3.5a.9-B](./3.5a.9-B.md).
