...
/**
 * `TapBudget` (GLOSSARY.md "Conteo de toques"): the standard PLAN-FASE-3-5-PORCINO.md
 ...
 * that is the compuerta firing: PLAN-FASE-3-5-PORCINO.md sec.2.3 says fix the flow, not
 * relax the number.
 */
