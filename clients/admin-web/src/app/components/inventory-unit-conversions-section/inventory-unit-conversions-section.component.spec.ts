...
describe('InventoryUnitConversionsSectionComponent', () => {
  ...
  beforeEach(async () => {
    apiStub = { registerInventoryUnitConversion: () => of({ id: 'c1' }) };
    await TestBed.configureTestingModule({
      imports: [InventoryUnitConversionsSectionComponent],
      providers: [provideRouter([]), { provide: ApiService, useValue: apiStub }],
    }).compileComponents();
  });
  it('shows conversion rows', () => {
    const fixture = TestBed.createComponent(InventoryUnitConversionsSectionComponent);
    fixture.componentInstance.conversions = [
      { id: 'c1', fromUnit: 'kg', toUnit: 'g', factor: 1000 } satisfies InventoryUnitConversionDto,
    ];
  ...
  it('opens the creation form', () => {
    ...
    fixture.detectChanges();
    expect(fixture.nativeElement.querySelector('#from-unit')).toBeTruthy();
  });
  it('calls the API on submit', () => {
    const fixture = TestBed.createComponent(InventoryUnitConversionsSectionComponent);
    fixture.componentInstance.itemId = 'i1';
    fixture.componentInstance.fromUnit = 'kg';
    fixture.componentInstance.toUnit = 'g';
    fixture.componentInstance.factor = 1000;
    fixture.detectChanges();
    vi.spyOn(apiStub, 'registerInventoryUnitConversion');
    fixture.componentInstance.create();
    expect(apiStub.registerInventoryUnitConversion).toHaveBeenCalledWith('i1', {
      FromUnit: 'kg',
      ToUnit: 'g',
      Factor: 1000,
    });
