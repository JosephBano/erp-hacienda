# 3.5b.5-C — Advertencias visibles y versionado de definiciones
...
- **Pares del split:**
  ...
  - [`3.5b.5-B`](./3.5b.5-B.md) (rama `feature/livestock-selection-criterion-deprecation`): absorción de `SelectionCriterion` — **recomendada** (las semillas con alertas visibles vienen de B).
...
- `[3.5b.5-B](./3.5b.5-B.md)` ya drenó — `Temperamento`
