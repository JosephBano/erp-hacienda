...
describe('InventoryItemDetailComponent', () => {
  const item: InventoryItemDetailDto = {
    id: 'i1',
    name: 'Maíz',
    category: 'Feed',
    unit: 'kg',
  ...
  const conversions: InventoryUnitConversionDto[] = [
    { id: 'c1', fromUnit: 'kg', toUnit: 'g', factor: 1000 },
  ];
  ...
  it('renders title and sections', () => {
    ...
    expect(fixture.nativeElement.querySelector('.page-title').textContent).toContain('Maíz');
    expect(fixture.nativeElement.textContent).toContain('Lotes');
    expect(fixture.nativeElement.textContent).toContain('Conversiones de unidad');
  });
  it('shows not found for a 404', () => {
    apiStub.getInventoryItemById = () => throwError(() => ({ status: 404 }));
    const fixture = TestBed.createComponent(InventoryItemDetailComponent);
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toContain('Ítem no encontrado');
  });
  it('renders feed stage only for feed items', () => {
    const fixture = TestBed.createComponent(InventoryItemDetailComponent);
    fixture.detectChanges();
    expect(fixture.nativeElement.textContent).toContain('Etapa de alimento');
  });
  it('has no emoji in visible text', () => {
    const fixture = TestBed.createComponent(InventoryItemDetailComponent);
    fixture.detectChanges();
...
describe('InventoryItemDetailComponent — Consumos registrados (consumption-history feature)', () => {
  ...
  const consumptions: InventoryConsumptionListItem[] = [
    ...
    },
    {
      ...
      inventoryItemName: 'Maíz',
      quantityRecorded: 5,
      unitRecorded: 'saco40kg',
      quantityInBaseUnit: 200,
      appliedFactor: 40,
      batchId: null,
      consumedAt: older,
      recordedByLabel: 'mayordomo',
      notes: 'Ración diaria',
    },
  ];
