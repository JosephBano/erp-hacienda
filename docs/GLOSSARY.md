...
| Clasificación por peso | `WeightSorting` | Reparto de una cohorte destetada en lotes de engorde por tamaño (pequeños / medianos / grandes). En lotes por conteo marcaba el cese de identificación individual; con identificación por arete (feature-0007 / ADR-0027) los individuos identificados conservan su identidad y seguimiento a lo largo de la clasificación. |
