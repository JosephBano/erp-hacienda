...
/// <summary>
/// docs/planes/fase-3-5/spec-3.5a.md sec.3.5a.7 task 5: "consumo de alimento del lote en sacos"
...
public class SyncPushFeedConsumptionTests(SyncApiFactory factory)
{
    ...
    /// step (docs/planes/fase-3/spec.md sec.2.2), exercised here because feed consumption decrements a
