...
namespace Hato.Modules.Inventory.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260813141042_AddInventoryReceptionFields")]
    partial class AddInventoryReceptionFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hato.Modules.Inventory.Domain.InventoryBatch", b =>
                {
                    ...
                    b.Property<string>("SupplierLabel")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("supplier_label");
                    ...
                    b.HasIndex("ReceivedAt")
                        .HasDatabaseName("ix_inventory_batches_received_at");
