...
public class Species : AuditableEntity
{
    ...
    /// (docs/planes/fase-3-5/spec-3.5a.md sec.3.5a.4). Null until an operator sets it; the
    ...
    /// of opening a new one (docs/planes/fase-3-5/spec-3.5a.md sec.3.5a.4). The client's operation
